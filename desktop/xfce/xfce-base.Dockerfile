...
# thanks https://github.com/mviereck/dockerfile-x11docker-xfce
...
LABEL org.opencontainers.image.title='ghcr.io/mmguero/xfce-base:latest'
LABEL org.opencontainers.image.description='Dockerized XFCE base image'
